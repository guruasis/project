...
-- changes in doctor and patient insert and update procedures
...
@DoctorEmailId VarChar(100),
@DoctorGender VarChar(10),
@DoctorAge int,
@DoctorExperience int,
@DoctorDepartmentId int,
@DoctorDesignationId int,
@DoctorSpeciality varChar(50),
@DoctorPassword Varchar(20)
)
As
begin
insert into tblDoctor(DoctorId,DoctorName,DoctorAddress,DoctorCityId,DoctorStateId,DoctorCountryId,DoctorPincode,DoctorPhoneNumber,DoctorPicture,DoctorHospitalId,DoctorEmailId,DoctorGender,DoctorAge,DoctorExperience,DoctorDepartmentId,DoctorDesignationId,DoctorSpeciality,DoctorPassword) values(@DoctorId,@DoctorName,@DoctorAddress,@DoctorCityId,@DoctorStateId,@DoctorCountryId,@DoctorPincode,@DoctorPhoneNumber,@DoctorPicture,@DoctorHospitalId,@DoctorEmailId,@DoctorGender,@DoctorAge,@DoctorExperience,@DoctorDepartmentId,@DoctorDesignationId,@DoctorSpeciality,@DoctorPassword)
end
...
As
Begin
Update tblDoctor set DoctorName=@DoctorName,DoctorAddress=@DoctorAddress,DoctorCityId=@DoctorCityId,DoctorStateId=@DoctorStateId,DoctorCountryId=@DoctorCountryId,DoctorPincode=@DoctorPincode,DoctorPhoneNumber=@DoctorPhoneNumber,DoctorPicture=@DoctorPicture,DoctorHospitalId=@DoctorHospitalId,DoctorEmailId=@DoctorEmailId,DoctorGender=@DoctorGender,DoctorAge=@DoctorAge,DoctorExperience=@DoctorExperience,DoctorDepartmentId=@DoctorDepartmentId,DoctorDesignationId=@DoctorDesignationId,DoctorSpeciality=@DoctorSpeciality,DoctorPassword=@DoctorPassword where DoctorId=@DoctorId
End
...
@PatientHospitalId int,
@PatientPassword VarChar(20)
)
As
begin
insert into tblPatient(PatientId,PatientName,PatientAddress,PatientCityId,PatientStateId,PatientCountryId,PatientPincode,PatientPhoneNumber,PatientEmailId,PatientGender,PatientAge,PatientAnnualSalary,PatientDiseaseId,PatientSubDiseaseId,PatientPicture,PatientHospitalId,PatientPassword) values(@PatientId,@PatientName,@PatientAddress,@PatientCityId,@PatientStateId,@PatientCountryId,@patientPincode,@PatientPhoneNumber,@PatientEmailId,@PatientGender,@PatientAge,@PatientAnnualSalary,@PatientDiseaseId,@PatientSubDiseaseId,@PatientPicture,@PatientHospitalId,@PatientPassword)
end
...
As
Begin
Update tblPatient set PatientName=@PatientName,PatientAddress=@PatientAddress,PatientCityId=@PatientCityId,PatientStateId=@PatientStateId,PatientCountryId=@PatientCountryId,PatientPincode=@PatientPincode,PatientPhoneNumber=@PatientPhoneNumber,PatientEmailId=@PatientEmailId,PatientGender=@PatientGender,PatientAge=@PatientAge,PatientAnnualSalary=@PatientAnnualSalary,PatientDiseaseId=@PatientDiseaseId,PatientSubDiseaseId=@PatientSubDiseaseId,PatientPicture=@PatientPicture,PatientHospitalId=@PatientHospitalId,PatientPassword=@PatientPassword where PatientId=@PatientId
End
